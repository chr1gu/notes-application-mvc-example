...
namespace NotesApplication.Extensions.Alerts
{
    public class AlertDecoratorResult : IActionResult
    {
        ...
        {
            // NOTE: Be sure you add a using statement for Microsoft.Extensions.DependencyInjection,
            //       otherwise this overload of GetService won't be available!
